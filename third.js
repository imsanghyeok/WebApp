...
var f = getGreeting; //변수 f에 함수참조값을 넣어줘서 f를 함수로 사용가능
console.log(f());
console.log("==================================================================");
...
func3(o3);
console.log(`func3를 호출한 후 : o.message = "${o2.message}"`);
console.log("==================================================================");
...
console.log(o7.speak());//this 사용가능

var speak = o7.speak;

console.log(speak == o7.speak);
console.log(speak());//this 사용 불가능
console.log("===================================================================");
...
var f13 = function(a,b){return a + b;}
var f13_r = (a, b) => a + b;
...
update.call(bruce, 1949, 'singer'); //2번째 인자부터 대입?한다
console.log(bruce);
